...
- [[https://github.com/lllShamanlll/agent-shell-org-config][agent-shell-org-config]]: Keep =agent-shell= agent, project, and skill definitions in org-roam.
...
| agent-shell-show-key-hints                    | Non-nil to display the key hint row in viewport headers.                        |
